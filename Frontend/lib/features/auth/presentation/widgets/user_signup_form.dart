...
class UserSignupForm extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UserSignupForm> createState() => _UserSignupFormState();
}

class _UserSignupFormState extends ConsumerState<UserSignupForm> {
  ...
  Future<void> _submit() async {
    ...
    if (!_termsAccepted) {
      setState(() =>
          _termsError = 'Você deve aceitar os Termos e Condições para continuar');
      return;
    }
    ...
    try {
      ...
      if (!mounted) return;
      widget.onSuccess?.call(AuthRole.guest);
      ...
      child: Column(
        ...
        children: [
          ...
          _isLoading
              ...
              : PrimaryButton(text: 'Cadastrar', onPressed: _submit),
          if (widget.onSwitchToHost != null) ...[
            const SizedBox(height: 16),
            Center(
              child: TextButton(
                onPressed: widget.onSwitchToHost,
                child: const Text(
